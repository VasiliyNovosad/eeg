...
ES_AffectivGetMeditationScore = libEDK.ES_AffectivGetMeditationScore
ES_AffectivGetMeditationScore.restype = c_float
ES_AffectivGetMeditationScore.argtypes = [c_void_p]

ES_AffectivGetFrustrationScore = libEDK.ES_AffectivGetFrustrationScore
ES_AffectivGetFrustrationScore.restype = c_float
ES_AffectivGetFrustrationScore.argtypes = [c_void_p]
...
def logEmoState(userID, eState):
    ...
    print >> f, ES_AffectivGetMeditationScore(eState), ",",
    print >> f, ES_AffectivGetFrustrationScore(eState), ",",
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------
header = ['Time', 'UserID', 'Wireless Signal Status', 'Blink', 'Wink Left', 'Wink Right', 'Look Left', 'Look Right', 'Eyebrow', 'Furrow', 'Smile', 'Clench', 'Smirk Left', 'Smirk Right', 'Laugh', 'Short Term Excitement', 'Long Term Excitement', 'Engagement/Boredom', 'Meditation', 'Frustration', 'Cognitiv Action', 'Cognitiv Power']
